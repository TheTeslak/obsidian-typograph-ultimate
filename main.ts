...
export default class TypographPlugin extends Plugin {
    ...
    applyTypography(editor: Editor) {
        ...
        if (formattedText !== originalText) {
            ...
            new Notice(`Typograph applied ${changesCount} changes made`);
        } else {
            editor.setValue(formattedText);
    ...
    applyTypographyRules(text: string): { formattedText: string, changesCount: number } {
        ...
        const skipLists: string[] = [];
        const skipQuotes: string[] = [];
        const skipHeadings: string[] = [];
        const skipLinks: string[] = [];
        const skipTables: string[] = [];
        const skipHtmlTags: string[] = [];
        const skipHighlights: string[] = [];
